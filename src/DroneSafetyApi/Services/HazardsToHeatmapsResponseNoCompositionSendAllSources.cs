...
namespace DroneSafetyApi.Services
{
    ...
    {
        public HeatmapsResponse ConvertToHeatmapResponse(double resolution, BoundingBox area, IEnumerable<Hazard> hazards)
        {
        ...
        public abstract HeatMap ConvertToHeatmap(double resolution, BoundingBox area, IEnumerable<Hazard> hazards);
    }
}
