...
namespace DroneSafetyApi.Services
{
    ...
    {
        public HeatmapsResponse ConvertToHeatmapResponse(BoundingBox area, int NumberLonPoints, IEnumerable<Hazard> hazards)
        {
        ...
        public abstract HeatMap ConvertToHeatmap(BoundingBox area, int width, IEnumerable<Hazard> hazards);
    }
}
